...
zokou(
  ...
  async (dest, zk, commandeOptions) => {
    ...
    const fullImageUrl = "https://i.imgur.com/NDgCS5N.jpeg"; // Full image URL
    const smallThumbnailUrl = "https://i.imgur.com/kxX09yG.jpeg"; // Small thumbnail URL
    const randomAudio = "https://files.catbox.moe/n48x8j.mp3"; // Voice note URL
    const sourceUrl = "https://whatsapp.com/channel/0029Vb3Vx4jCBtx6yFD45S19"; // Channel link
    ...
    try {
      ...
      await zk.sendMessage(dest, {
        ...
        contextInfo: {
          externalAdReply: {
            title: `💦 Message from: ${contactName}\n🔥𝐔𝐋𝐓𝐈𝐌𝐀𝐓𝐔𝐌-𝐕1 Alive🔥`, // Your contact in WhatsApp status format
            body: "I'm always active 🥱 Tap here",
  ...
  async (dest, zk, commandeOptions) => {
    ...
    try {
      ...
      await zk.sendMessage(dest, {
        ...
        contextInfo: {
          externalAdReply: {
            title: `🌟 Message from: ${contactName}\n🔥 𝐔𝐋𝐓𝐈𝐌𝐀𝐓𝐔𝐌-𝐕1  is alive 🔥`, // Your contact in WhatsApp status format
            body: "I'm always active 🌚🥱 Tap here",
            thumbnailUrl: smallThumbnailUrl, // Small thumbnail displayed below
            mediaType: 1, // Indicate this is an image
            renderLargerThumbnail: true, // Ensure thumbnail is displayed in full
