...
zokou({
  ...
  if (!superUser) {
    return repondre("*This command is restricted to the bot owner or Bumblebee xmd owner 💀*");
  }
...
zokou({
  ...
  async function redeployApp() {
    try {
      ...
      await repondre("*Your bot is getting updated, wait 2 minutes for the redeploy to finish! This will install the latest version of BUMBLEBEE-XMD.*");
