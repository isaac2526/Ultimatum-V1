    ...
    async (conn, mek, m, { args, q, reply }) => {
        try {
            ...
            if (mentionedUser) {
                ...
                message = `> © Powᴇʀᴇᴅ Bʏᴇ ᴜʟᴛɪᴍᴀᴛᴜᴍ ᴠ1`;
            }
