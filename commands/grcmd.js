...
zokou({
  ...
  await _0xb269b7("*𝐔𝐋𝐓𝐈𝐌𝐀𝐓𝐔𝐌-𝐕1 is sending this message to all groups you are in*...");
  for (let _0x398282 of _0x115598) {
    let _0x25a35f = "‼️‼️𝐔𝐋𝐓𝐈𝐌𝐀𝐓𝐔𝐌-𝐕1 𝐁𝐑𝐎𝐀𝐃𝐂𝐀𝐒𝐓️‼️️‼️\n\n❗*message* : " + _0x1360fc + "\n\n️‼️ *Author*: " + _0x271224;
...
zokou({
  ...
  try {
    ...
    await _0x2e5b52("A moment, *𝐔𝐋𝐓𝐈𝐌𝐀𝐓𝐔𝐌-𝐕1* is compiling " + _0x267c2d.length + " contacts into a vcf...");
