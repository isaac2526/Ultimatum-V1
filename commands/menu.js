...
const fetchGitHubStats = async () => {
    try {
        const repo = 'isaac2526/Ultimatum-V1'; // Replace with your repo
...
╰═════════════════⊷\n`;
    ...
    menuMsg += `
> © 𝗽𝗼𝘄𝗲𝗿𝗲𝗱 𝗯𝘆 𝐈𝐒𝐀𝐀𝐂 𝐀𝐑𝐈𝐍𝐎𝐋𝐀 𝐓𝐄𝐂𝐇❄️`;
            ...
            contextInfo: {
               ...
               showAdAttribution: true,
                externalAdReply: {
                    ...
                    thumbnailUrl: "https://i.imgur.com/3NaidB1.jpeg",
                    sourceUrl: 'https://whatsapp.com/channel/0029Vb3Vx4jCBtx6yFD45S19',
                    mediaType: 1,
...
zokou({ nomCom: "list", categorie: "General" }, async (dest, zk, commandeOptions) => {
    ...
    // Set the default timezone from the configuration
    moment.tz.setDefault('Africa/Abuja');
            ...
            contextInfo: {
               ...
               showAdAttribution: true,
                externalAdReply: {
                    title: "𝐔𝐋𝐓𝐈𝐌𝐀𝐓𝐔𝐌-𝐕1",
                    body: "ᴛᴀᴘ ʜᴇʀᴇ ᴛᴏ ғᴏʟʟᴏᴡ ᴏᴜʀ ᴄʜᴀɴɴᴇʟ",
                    thumbnailUrl: "https://i.imgur.com/oQRzihP.jpeg",
                    sourceUrl: 'https://whatsapp.com/channel/0029Vb3Vx4jCBtx6yFD45S19',
                    mediaType: 1,
                    renderLargerThumbnail: true
                }
